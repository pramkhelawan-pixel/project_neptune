  ...
  KnowledgeRecord(
    ...
    sources: const [
      KnowledgeSource(
        ...
        reference: 'NKB-SGS-016',
        reliability: 0.89,
      ),
    ],
    regions: const ['South Africa'],
    seasons: const [],
    tags: const ['conservation', 'regulations', 'bag limit', 'spotted gully shark'],
    verified: true,
    createdAt: DateTime(2026, 8, 8),
    updatedAt: DateTime(2026, 8, 8),
  ),
  KnowledgeRecord(
    id: 'NKB-SGS-CONSERVATION-0002',
    species: 'Spotted Gully Shark',
    targetSpecies: const ['Spotted Gully Shark'],
    category: KnowledgeCategory.conservation,
    title: 'Protected Species: Commercial Sale Prohibited',
    description:
    'Protected Species: Commercially delisted under the Marine Living Resources Act, no sale permitted.',
    evidenceLevel: EvidenceLevel.regulatory,
