  ...
  KnowledgeRecord(
    ...
    sources: const [
      KnowledgeSource(
        ...
        reference: 'NKB-RTS-017',
        reliability: 0.89,
      ),
    ],
    regions: const ['South Africa'],
    seasons: const [],
    tags: const ['conservation', 'regulations', 'bag limit', 'ragged-tooth shark'],
    verified: true,
    createdAt: DateTime(2026, 8, 8),
    updatedAt: DateTime(2026, 8, 8),
  ),
  KnowledgeRecord(
    id: 'NKB-RTS-CONSERVATION-0003',
    species: 'Ragged-tooth Shark',
    targetSpecies: const ['Ragged-tooth Shark'],
    category: KnowledgeCategory.conservation,
    title: 'Protected Species: Commercial Sale Prohibited',
    description:
    'Protected Species: Commercially delisted under the Marine Living Resources Act, no sale permitted. The Ragged-tooth Shark is also classified as Critically Endangered on the IUCN Red List.',
    evidenceLevel: EvidenceLevel.regulatory,
    confidenceLevel: ConfidenceLevel.veryHigh,
    sources: const [
      KnowledgeSource(
